...
import java.sql.*;
class StkTable extends JFrame implements ActionListener
	{
	 JButton b1;
	 int count,i=0;
	...
	//		 Connection con=DriverManager.getConnection("jdbc:odbc:Emp1");
			 ...
			 String s[]={"ItemCategory","Item","Supplier","CurrentStock","Date","Units","Price/Unit","AmountPayable","status"};
			 String s1[][]=new String[count][9];
			 PreparedStatement ps1=con.prepareStatement("select * from Purchase");
