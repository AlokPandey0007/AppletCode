...
import java.sql.*;
class Empcode extends JFrame implements ActionListener
	{
	 JComboBox cb1;
		 ...
		 try
			{
			 ...
			 PreparedStatement ps=con.prepareStatement("select EmpID from EmpTabel");
		 ...
		 try
			{
			 ...
			 PreparedStatement ps1=con.prepareStatement("select * from EmpTabel where EmpID=?");
