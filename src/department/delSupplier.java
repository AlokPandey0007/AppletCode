...
class delSupplier extends JFrame implements ActionListener, ItemListener
	{
	 TextField t1;
	 List li;
	 JButton b1,b2,b3;
		 ...
		 if(e1.getSource()==li)
			{
			 try
				...
				PreparedStatement ps1=con.prepareStatement("select SplName from SplTabel where SplName=?");
			 ...
			 try
				{
				 ...
				 // Class.forName("com.mysql.jdbc.Driver");
                      // Connection con = DriverManager.getConnection("jdbc:mysql://localhost/emp1","root","");
				 PreparedStatement ps2=con.prepareStatement("delete from SplTabel where SplName=?");
